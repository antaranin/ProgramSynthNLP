...
if __name__ == '__main__':
    ...
    parser.add_argument('--fn_out_model', type=str, default='miniscan_final.p',
    ...
    parser.add_argument('--savefile', type=str, default="results/mini_scan.p")
    ...
    print(
        f"average nodes expanded: {sum(result.stats['nodes_expanded'] for samp, result in results) / len(results)}")
